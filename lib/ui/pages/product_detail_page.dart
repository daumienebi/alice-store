...
class ProductDetailPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      slivers: [
        SliverAppBar(
          ...
          elevation: 0,
          actions: [
            productInWishListIcon(product,context)
          ],
          leading: Padding(
  ...
  Widget productInWishListIcon(Product product,BuildContext context){
    ...
    bool isInWishList = provider.getWishListProducts.where((element) =>
    element.id == product.id).isNotEmpty;

    //Possible Icons
    var addToFavIcon = const Icon(Icons.favorite_border,color: Colors.black,);
